...
* TREE-SITTER
Tree-sitter is a open standard with bindings to emacs (similar to LSP or DAP) that allows for improve understanding of code languages. This is used here primarily to get better syntax highlighting while coding.
