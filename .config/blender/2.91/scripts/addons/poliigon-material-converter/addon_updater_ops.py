...
updater.addon = "poliigon_converter"
...
def update_settings_ui(self, context, element=None):
	...
	if updater.error != None:
		...
		col.operator(addon_updater_check_now.bl_idname,
			text="Check now for converter update")
...
def register(bl_info):
	...
	updater.repo = "poliigon-material-converter"

	#updater.addon = # define at top of module, MUST be done first

	# Website for manual addon download, optional but recommended to set
	updater.website = "https://help.poliigon.com/tools-and-add-ons/poliigon-material-converter-addon-for-blender"
	...
	updater.overwrite_patterns = ["*.png","README.md","LICENSE.txt", "*.json"]
